var app =angular.module('facturacionApp');
  app.controller('MisProformasCtrl', function ($scope,$rootScope, $location,$localStorage,$mdDialog,Facturacion_Services,Servicios_Generales) {
			console.log('Mis proformas');
	  	});

   app.controller('ProformasCtrl', function ($scope,$rootScope, $location,$localStorage,$mdDialog,Facturacion_Services,Servicios_Generales,Configuracion_Services,Inventario_Services ) {
